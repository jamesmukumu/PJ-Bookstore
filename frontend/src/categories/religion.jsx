...
function Religioncategory(){
const [mycategory,setMycategory] = useState('Religion')
...
<div className="fantasy"><strong>RELIGION BOOKS</strong></div>
...
export default Religioncategory